...
export default async function Home() {
  ...
  return (
    <div className="w-full">
      <Container>
        <h1 className="text-center font-bold text-xl mt-8 mb-5">Separamos um jogo exclusivo pra vc</h1>
        ...
        <section className="w-full bg-black rounded-lg">
          <div className="w-full max-h-96 h-96 relative rounded-lg">
            ...
            <div className="absolute z-20 bottom-0 p-3 flex justify-center items-center gap-2">
             ...
             <Image src={dalyGame.image_url} alt={dalyGame.title} priority={true} quality={100}
          fill={true} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 44vw"
